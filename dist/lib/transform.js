...
exports.list2Dict = list2Dict;
exports.list2Tree = list2Tree;
exports.tree2List = tree2List;
function list2Dict(lst, key, contentKey) {
    var dct = {};
...
function list2Tree(listData, options) {
...
function tree2List(treeData, options) {
    if (options === void 0) { options = {
        key: 'key',
        parent: 'parent'
    }; }
